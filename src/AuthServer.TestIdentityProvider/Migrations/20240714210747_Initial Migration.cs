        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AuthorizationSignedResponseAlg = table.Column<int>(type: "int", nullable: true),
                    AuthorizationEncryptedResponseAlg = table.Column<int>(type: "int", nullable: true),
                    AuthorizationEncryptedResponseEnc = table.Column<int>(type: "int", nullable: true),
