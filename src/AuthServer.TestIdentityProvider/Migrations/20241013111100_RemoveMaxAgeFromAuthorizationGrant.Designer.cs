...
namespace AuthServer.TestIdentityProvider.Migrations
{
    ...
    [Migration("20241013111100_RemoveMaxAgeFromAuthorizationGrant")]
    partial class RemoveMaxAgeFromAuthorizationGrant
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AuthenticationMethodReferenceAuthorizationGrant", b =>
                {
                    b.Property<int>("AuthenticationMethodReferencesId")
                        .HasColumnType("int");

                    b.Property<string>("AuthorizationGrantsId")
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("AuthenticationMethodReferencesId", "AuthorizationGrantsId");

                    b.HasIndex("AuthorizationGrantsId");

                    b.ToTable("AuthenticationMethodReferenceAuthorizationGrant");
                });
            ...
            modelBuilder.Entity("AuthenticationMethodReferenceAuthorizationGrant", b =>
                {
                    b.HasOne("AuthServer.Entities.AuthenticationMethodReference", null)
                        .WithMany()
                        .HasForeignKey("AuthenticationMethodReferencesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AuthServer.Entities.AuthorizationGrant", null)
                        .WithMany()
                        .HasForeignKey("AuthorizationGrantsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
