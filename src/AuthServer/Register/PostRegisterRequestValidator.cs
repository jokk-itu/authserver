...
internal class PostRegisterRequestValidator : IRequestValidator<RegisterRequest, PostRegisterValidatedRequest>
{
	...
	public async Task<ProcessResult<PostRegisterValidatedRequest, ProcessError>> Validate(RegisterRequest request,
		CancellationToken cancellationToken)
	{
		...
		{
			return PostRegisterError.InvalidApplicationType;
		}
