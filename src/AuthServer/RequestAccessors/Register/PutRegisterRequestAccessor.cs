...
internal class PutRegisterRequestAccessor : IRequestAccessor<PutRegisterRequest>
{
	public async Task<PutRegisterRequest> GetRequest(HttpRequest httpRequest)
	{
		...
		var authorizationEncryptedResponseEnc = json.GetValueOrEmpty(Parameter.AuthorizationEncryptedResponseEnc);
		var authorizationEncryptedResponseAlg = json.GetValueOrEmpty(Parameter.AuthorizationEncryptedResponseAlg);
		var authorizationSignedResponseAlg = json.GetValueOrEmpty(Parameter.AuthorizationSignedResponseAlg);
