...
{
    public static readonly ProcessError UnsupportedTokenType = new(ErrorCode.UnsupportedTokenType,
        "provided token_type_hint is unsupported", ResultCode.BadRequest);

    public static readonly ProcessError EmptyToken = new(ErrorCode.InvalidRequest,
        "token must not be null or empty", ResultCode.BadRequest);
