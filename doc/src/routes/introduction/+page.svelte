<div>
    ...
    <p class="mb-4">An IdentityProvider implementing the core OAuth 2.1 specification, with the OpenId Connect specification on top.
        <br/>
    ...
    <h2 class="text-xl mb-4">What does it do for you?</h2>
    ...
    <div class="grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
        ...
        <div class="max-w-sm rounded overflow-hidden shadow-lg px-6 py-4">
            ...
            <p class="text-gray-800 text-base">
                Choose typed JWT with signatures and optionally encryption and sender constraints.
                Or use Opaque tokens with Introspection.
            </p>
        </div>
        ...
        <div class="max-w-sm rounded overflow-hidden shadow-lg px-6 py-4">
            ...
            <div class="font-bold text-xl mb-2">Clients</div>
            <p class="text-gray-800 text-base">
        ...
        <div class="max-w-sm rounded overflow-hidden shadow-lg px-6 py-4">
            ...
            <p class="text-gray-800 text-base">Authserver uses EF Core for persistance
                and uses distributed caching for fast retrieval of common entities without stale entries.</p>
        </div>
        ...
        <div class="max-w-sm rounded overflow-hidden shadow-lg px-6 py-4">
            ...
            <div class="font-bold text-xl mb-2">Distributed</div>
            <p class="text-gray-800 text-base">
                Designed to be a distributed application with multiple instances,
                enabling scalability for your specific needs.
            </p>
        </div>
        ...
        <div class="max-w-sm rounded overflow-hidden shadow-lg px-6 py-4">
            ...
            <p class="text-gray-800 text-base">
                Easily setup your custom Authserver using depdency injection
                in your AspNet Core application.
            </p>
        </div>
        ...
        <div class="max-w-sm rounded overflow-hidden shadow-lg px-6 py-4">
            ...
            <p class="text-gray-800 text-base">
                Usage of claims in userinfo and id tokens.
                Identifies users by subject identifiers of type public and pairwise.
            </p>
        </div>
        ...
        <div class="max-w-sm rounded overflow-hidden shadow-lg px-6 py-4">
            ...
            <div class="font-bold text-xl mb-2">Discovery</div>
            <p class="text-gray-800 text-base">
                Identify endpoints and supported features through the discovery endpoint,
                and identify signature and encryption keys through the Jwks endpoint.
            </p>
        </div>
        ...
        <div class="max-w-sm rounded overflow-hidden shadow-lg px-6 py-4">
            ...
            <div class="font-bold text-xl mb-2">Open Telemetry</div>
            <p class="text-gray-800 text-base">
        ...
        <div class="max-w-sm rounded overflow-hidden shadow-lg px-6 py-4">
            ...
            <div class="font-bold text-xl mb-2">OAuth 2.1</div>
            <p class="text-gray-800 text-base">
