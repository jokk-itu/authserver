import{S as $e,i as Te,s as we,c as V,a as T,b as X,d as w,m as Y,k as s,o as g,p as ee,q as te,j as t,t as p,h as f,e as l,f as a,g as v,r as be,l as b,n as he}from"../../../chunks/index-8ff2e5dd.js";import{P as ve}from"../../../chunks/PageTitle-edc21ece.js";import{S as fe}from"../../../chunks/Section-732b932d.js";function ye(B){let i;return{c(){i=p(`Is used to get a structured token, by passing a reference token to the
...
`),O=l("br"),C=l("br"),S=p(`
The request can look like the following using Basic client authentication:`),H=l("br"),W=T(),I=l("pre"),se=p(`    POST /connect/introspect HTTP/1.1
...
OPTIONAL. Can be one of the following values: access_token and refresh_token.
`),O=a(e,"BR",{}),C=a(e,"BR",{}),S=f(e,`
The request can look like the following using Basic client authentication:`),H=a(e,"BR",{}),W=w(e),I=a(e,"PRE",{});var ke=v(I);se=f(ke,`    POST /connect/introspect HTTP/1.1
    Host: idp.authserver.dk
    Accept: application/json
    Content-Type: application/x-www-form-urlencoded
    Authorization: Basic czZCaGRSa3F0MzpnWDFmQmF0M2JW
