import{S as As,i as Os,s as Ns,y as c,a as d,z as h,c as R,A as g,b as s,g as ee,d as te,B as se,h as t,q as o,r as f,k as r,l,m as _,n as Lt,D as b,H as ls}from"../chunks/index.8cffed02.js";import{P as Ts}from"../chunks/PageTitle.df959b80.js";import{S as Ut}from"../chunks/Section.be805b22.js";function zs(N){let u;return{c(){u=o(`Discovery is used for relying parties to fetch information
...
`),Me=r("br"),Qe=r("br"),Ve=d(),q=r("b"),Yt=o("subject_types"),Ge=r("br"),Xe=o(`
...
"RS256" is supported.
`),et=r("br"),tt=r("br"),st=d(),H=r("b"),ct=o("token_endpoint_auth_methods_supported"),it=r("br"),rt=o(`
...
`),lt=r("br"),pt=r("br"),ot=d(),M=r("b"),ht=o("token_endpoint_auth_signing_alg_values_supported"),ft=r("br"),ut=o(`
JSON array of supported alg methods for signing tokens issued at the token endpoint.
"RS256" is supported.
`),nt=r("br"),bt=r("br"),_t=d(),Q=r("b"),gt=o("revocation_endpoint"),mt=r("br"),vt=o(`
Absolute url to the revocation endpoint e.g: https://idp.authserver.dk/connect/revoke
`),Bt=r("br"),dt=r("br"),Rt=d(),V=r("b"),es=o("revocation_endpoint_auth_methods_supported"),yt=r("br"),kt=o(`
JSON array of supported client authentication methods at the revocation endpoint.
"client_secret_basic" and "client_secret_post" are supported.
`),G=r("b"),ts=o("introspection_endpoint"),$t=r("br"),wt=o(`
...
"R256" is supported.
`),xt=r("br"),Dt=r("br"),It=d(),Z=r("b"),rs=o("claims_supported"),Kt=r("br"),jt=o(`
...
Absolute url to the token endpoint e.g: https://idp.authserver.dk/connect/token
`),re=l(e,"BR",{}),le=l(e,"BR",{}),pe=R(e),D=l(e,"B",{});var fs=_(D);qt=f(fs,"userinfo_endpoint"),fs.forEach(t),oe=l(e,"BR",{}),fe=f(e,`
Absolute url to the userinfo endpoint e.g: https://idp.authserver.dk/connect/userinfo
`),ue=l(e,"BR",{}),ne=l(e,"BR",{}),be=R(e),I=l(e,"B",{});var us=_(I);Ft=f(us,"jwks_uri"),us.forEach(t),_e=l(e,"BR",{}),me=f(e,`
Absolute url to the jwks document e.g: https://idp.authserver.dk/.well-known/jwks
`),ve=l(e,"BR",{}),Be=l(e,"BR",{}),de=R(e),K=l(e,"B",{});var ns=_(K);Ht=f(ns,"registration_endpoint"),ns.forEach(t),Re=l(e,"BR",{}),ye=f(e,`
Absolute url to the registration endpoint e.g: https://idp.authserver.dk/connect/register
`),ke=l(e,"BR",{}),$e=l(e,"BR",{}),we=R(e),j=l(e,"B",{});var bs=_(j);Mt=f(bs,"end_session_endpoint"),bs.forEach(t),Je=l(e,"BR",{}),ae=f(e,`
Absolute url of the endsession endpoint e.g: https://idp.authserver.dk/connect/end-session
`),Se=l(e,"BR",{}),Ee=l(e,"BR",{}),Ae=R(e),C=l(e,"B",{});var _s=_(C);Qt=f(_s,"scopes_supported"),_s.forEach(t),Oe=l(e,"BR",{}),Ne=f(e,`
JSON array of supported scopes defined by the IdP.
For example openid and profile.
Custom scopes used by protected resources are not shown.
`),Te=l(e,"BR",{}),ze=l(e,"BR",{}),We=R(e),P=l(e,"B",{});var ms=_(P);Vt=f(ms,"response_types_supported"),ms.forEach(t),xe=l(e,"BR",{}),De=f(e,`
JSON array of supported response_type values,
used in the authorize endpoint. "code" is the only supported value.
`),Ie=l(e,"BR",{}),Ke=l(e,"BR",{}),je=R(e),L=l(e,"B",{});var vs=_(L);Gt=f(vs,"response_modes_supported"),vs.forEach(t),Ce=l(e,"BR",{}),Pe=f(e,`
JSON array of supported response_mode values,
used in the authorize endpoint. "form_post" is the only supported value.
`),Le=l(e,"BR",{}),Ue=l(e,"BR",{}),qe=R(e),U=l(e,"B",{});var Bs=_(U);Xt=f(Bs,"grant_types_supported"),Bs.forEach(t),Fe=l(e,"BR",{}),He=f(e,`
JSON array of supported grant_type values,
used in the token endpoint. "authorization_code", "client_credentials" and "refresh_token" are supported.
`),Me=l(e,"BR",{}),Qe=l(e,"BR",{}),Ve=R(e),q=l(e,"B",{});var ds=_(q);Yt=f(ds,"subject_types"),ds.forEach(t),Ge=l(e,"BR",{}),Xe=f(e,`
JSON array of supported subject identifier types.
"public" is supported.
...
JSON array of supported alg values used for signing id tokens.
"RS256" is supported.
`),et=l(e,"BR",{}),tt=l(e,"BR",{}),st=R(e),H=l(e,"B",{});var ys=_(H);ct=f(ys,"token_endpoint_auth_methods_supported"),ys.forEach(t),it=l(e,"BR",{}),rt=f(e,`
JSON array of supported client authentication methods at the token endpoint.
"client_secret_basic" and "client_secret_post" are supported.
`),lt=l(e,"BR",{}),pt=l(e,"BR",{}),ot=R(e),M=l(e,"B",{});var ks=_(M);ht=f(ks,"token_endpoint_auth_signing_alg_values_supported"),ks.forEach(t),ft=l(e,"BR",{}),ut=f(e,`
JSON array of supported alg methods for signing tokens issued at the token endpoint.
"RS256" is supported.
`),nt=l(e,"BR",{}),bt=l(e,"BR",{}),_t=R(e),Q=l(e,"B",{});var $s=_(Q);gt=f($s,"revocation_endpoint"),$s.forEach(t),mt=l(e,"BR",{}),vt=f(e,`
Absolute url to the revocation endpoint e.g: https://idp.authserver.dk/connect/revoke
`),Bt=l(e,"BR",{}),dt=l(e,"BR",{}),Rt=R(e),V=l(e,"B",{});var ws=_(V);es=f(ws,"revocation_endpoint_auth_methods_supported"),ws.forEach(t),yt=l(e,"BR",{}),kt=f(e,`
JSON array of supported client authentication methods at the revocation endpoint.
"client_secret_basic" and "client_secret_post" are supported.
`),G=l(e,"B",{});var Js=_(G);ts=f(Js,"introspection_endpoint"),Js.forEach(t),$t=l(e,"BR",{}),wt=f(e,`
Absolute url to the introspection endpoint e.g: https://idp.authserver.dk/connect/introspect
...
JSON array of supported alg values used for PKCE.
"R256" is supported.
`),xt=l(e,"BR",{}),Dt=l(e,"BR",{}),It=R(e),Z=l(e,"B",{});var Es=_(Z);rs=f(Es,"claims_supported"),Es.forEach(t),Kt=l(e,"BR",{}),jt=f(e,`
JSON array of supported claims, which are found in id tokens and userinfo endpoint.
Claims include name, given_name, family_name, phone, email, address etc.
`),Ct=l(e,"BR",{}),Pt=l(e,"BR",{})},m(e,i){s(e,u,i),s(e,v,i),s(e,m,i),s(e,y,i),b(y,$),s(e,w,i),s(e,n,i),s(e,k,i),s(e,J,i),s(e,S,i),s(e,p,i),b(p,B),s(e,E,i),s(e,a,i),s(e,A,i),s(e,O,i),s(e,z,i),s(e,T,i),b(T,x),s(e,W,i),s(e,ie,i),s(e,re,i),s(e,le,i),s(e,pe,i),s(e,D,i),b(D,qt),s(e,oe,i),s(e,fe,i),s(e,ue,i),s(e,ne,i),s(e,be,i),s(e,I,i),b(I,Ft),s(e,_e,i),s(e,me,i),s(e,ve,i),s(e,Be,i),s(e,de,i),s(e,K,i),b(K,Ht),s(e,Re,i),s(e,ye,i),s(e,ke,i),s(e,$e,i),s(e,we,i),s(e,j,i),b(j,Mt),s(e,Je,i),s(e,ae,i),s(e,Se,i),s(e,Ee,i),s(e,Ae,i),s(e,C,i),b(C,Qt),s(e,Oe,i),s(e,Ne,i),s(e,Te,i),s(e,ze,i),s(e,We,i),s(e,P,i),b(P,Vt),s(e,xe,i),s(e,De,i),s(e,Ie,i),s(e,Ke,i),s(e,je,i),s(e,L,i),b(L,Gt),s(e,Ce,i),s(e,Pe,i),s(e,Le,i),s(e,Ue,i),s(e,qe,i),s(e,U,i),b(U,Xt),s(e,Fe,i),s(e,He,i),s(e,Me,i),s(e,Qe,i),s(e,Ve,i),s(e,q,i),b(q,Yt),s(e,Ge,i),s(e,Xe,i),s(e,Ye,i),s(e,Ze,i),s(e,ce,i),s(e,F,i),b(F,Zt),s(e,he,i),s(e,ge,i),s(e,et,i),s(e,tt,i),s(e,st,i),s(e,H,i),b(H,ct),s(e,it,i),s(e,rt,i),s(e,lt,i),s(e,pt,i),s(e,ot,i),s(e,M,i),b(M,ht),s(e,ft,i),s(e,ut,i),s(e,nt,i),s(e,bt,i),s(e,_t,i),s(e,Q,i),b(Q,gt),s(e,mt,i),s(e,vt,i),s(e,Bt,i),s(e,dt,i),s(e,Rt,i),s(e,V,i),b(V,es),s(e,yt,i),s(e,kt,i),s(e,G,i),b(G,ts),s(e,$t,i),s(e,wt,i),s(e,Jt,i),s(e,at,i),s(e,St,i),s(e,X,i),b(X,ss),s(e,Et,i),s(e,At,i),s(e,Ot,i),s(e,Nt,i),s(e,Tt,i),s(e,Y,i),b(Y,is),s(e,zt,i),s(e,Wt,i),s(e,xt,i),s(e,Dt,i),s(e,It,i),s(e,Z,i),b(Z,rs),s(e,Kt,i),s(e,jt,i),s(e,Ct,i),s(e,Pt,i)},p:ls,d(e){e&&t(u),e&&t(v),e&&t(m),e&&t(y),e&&t(w),e&&t(n),e&&t(k),e&&t(J),e&&t(S),e&&t(p),e&&t(E),e&&t(a),e&&t(A),e&&t(O),e&&t(z),e&&t(T),e&&t(W),e&&t(ie),e&&t(re),e&&t(le),e&&t(pe),e&&t(D),e&&t(oe),e&&t(fe),e&&t(ue),e&&t(ne),e&&t(be),e&&t(I),e&&t(_e),e&&t(me),e&&t(ve),e&&t(Be),e&&t(de),e&&t(K),e&&t(Re),e&&t(ye),e&&t(ke),e&&t($e),e&&t(we),e&&t(j),e&&t(Je),e&&t(ae),e&&t(Se),e&&t(Ee),e&&t(Ae),e&&t(C),e&&t(Oe),e&&t(Ne),e&&t(Te),e&&t(ze),e&&t(We),e&&t(P),e&&t(xe),e&&t(De),e&&t(Ie),e&&t(Ke),e&&t(je),e&&t(L),e&&t(Ce),e&&t(Pe),e&&t(Le),e&&t(Ue),e&&t(qe),e&&t(U),e&&t(Fe),e&&t(He),e&&t(Me),e&&t(Qe),e&&t(Ve),e&&t(q),e&&t(Ge),e&&t(Xe),e&&t(Ye),e&&t(Ze),e&&t(ce),e&&t(F),e&&t(he),e&&t(ge),e&&t(et),e&&t(tt),e&&t(st),e&&t(H),e&&t(it),e&&t(rt),e&&t(lt),e&&t(pt),e&&t(ot),e&&t(M),e&&t(ft),e&&t(ut),e&&t(nt),e&&t(bt),e&&t(_t),e&&t(Q),e&&t(mt),e&&t(vt),e&&t(Bt),e&&t(dt),e&&t(Rt),e&&t(V),e&&t(yt),e&&t(kt),e&&t(G),e&&t($t),e&&t(wt),e&&t(Jt),e&&t(at),e&&t(St),e&&t(X),e&&t(Et),e&&t(At),e&&t(Ot),e&&t(Nt),e&&t(Tt),e&&t(Y),e&&t(zt),e&&t(Wt),e&&t(xt),e&&t(Dt),e&&t(It),e&&t(Z),e&&t(Kt),e&&t(jt),e&&t(Ct),e&&t(Pt)}}}function Ds(N){let u,v,m,y,$=`
{
    "kty": "RSA",
    "use": "sig",
    "kid": 1,
