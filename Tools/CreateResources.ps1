...
$token = GetInitialToken 'https://localhost:5000/connect/resource/initial-token'

PostResource 'https://localhost:5000/connect/resource/register' $token 'weather' 'weather:read'

PostResource 'https://localhost:5000/connect/resource/register' $token 'identityprovider' 'identityprovider:userinfo'