...
public interface ITokenBuilder
{
    ...
    Task<string> BuildIdTokenAsync(string clientId, ICollection<string> scopes, string nonce, string userId, string sessionId, DateTime authTime, CancellationToken cancellationToken = default);
