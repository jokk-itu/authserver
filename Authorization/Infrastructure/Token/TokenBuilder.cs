...
public class TokenBuilder : ITokenBuilder
{
  ...
  public async Task<string> BuildAccessToken(string clientId, ICollection<string> scopes, string userId,
  ...
  public async Task<string> BuildRefreshToken(string clientId, ICollection<string> scopes, string userId,
    CancellationToken cancellationToken = default)
  {
